...
# Database connection
config <- furdeb::configuration_file(path_file = paste0(path.expand("~"), "/.appconfig/indicator_glossary/configuration_file_fishi.yml"),
                             silent = TRUE)
balbaya_con <- furdeb::postgresql_dbconnection(db_user = config[["databases_configuration"]][["balbaya_vmot5"]][["login"]],
