...
-   fishing activity: Fishing operations. Annual number of fishing sets
    on FOB-associated and free-swimming tuna schools.
...
-   catch per searching day (dataframe 1): Annual number of catch per
    positive set on FOB-associated and free-swimming schools.

-   catch per unit effort (dataframe 1): Annual catch rates (in t per
    searching day) on FOB- associated and free-swimming tuna schools
    (FSC).

-   map catch distribution: Spatial distribution of tuna catches.

-   map effort distribution: Spatial distribution of tuna effort.
...
-   sample_summary: gives the number of trips, vessels or wells sampled
    for a given year
